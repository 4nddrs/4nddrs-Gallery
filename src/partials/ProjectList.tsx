...
const ProjectList = () => (
  ...
  >
    <div className="flex flex-col gap-6">
      <Project
        name="Epp Check"
        description="An App to check the personal protective equipment (PPE) of workers in a company."
        link="https://github.com/4nddrs/eppCheck.git"
        img={{ src: '/assets/images/casco.png', alt: 'Project Python' }}
        category={
          <>
            <AstroLink href="#">
              <img
      ...
      <Project
        ...
        category={
          <>
            ...
            <AstroLink href="#">
              <img
                src="/assets/images/bash_dark.svg"
                alt=""
                width="20"
                height="20"
              />
      ...
      <Project
        ...
        category={
          <>
            <AstroLink href="#">
              <img
                src="/assets/images/logoHtml.png"
                alt=""
                width="17"
                height="17"
              />
      ...
      <Project
        ...
        category={
          <>
            ...
            <AstroLink href="#">
              <img
                src="/assets/images/aseprite.png"
                alt=""
                width="16"
                height="16"
              />
